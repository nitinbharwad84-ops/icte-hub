...
import { Users, Building2, GraduationCap, UserCog, DollarSign, Handshake, Flame, ShieldCheck, ScrollText, LogOut } from 'lucide-react';
...
const navItems = [
  ...
  { icon: ShieldCheck, label: 'Admin Management', href: '/owner/admins' },
  { icon: ScrollText, label: 'Audit Logs', href: '/owner/audit-logs' },
];
...
export function OwnerSidebar({ user, onClose }: OwnerSidebarProps) {
